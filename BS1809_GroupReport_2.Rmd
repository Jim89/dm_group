...
It is noted that advertising under the current approach (group 1) produced more _views_ than no advertising (group 0). However this increase in views did not appear to translate in to an increased number of reservations. Therefore an evaluation metric needed to be determined that captured this fact. The ratio of pageviews to reservations was used (termed _conversion rate_) as reservations were the desired outcome, and pageviews were representative of the effect of the advertising. 
...
From tables three and four it is seen that, for both chain and independent restaurants, the current avertising method resulsts in a _lower_ conversion rate than no advertising at all (and this difference is statistically significant). Similarly, the new ad-delivery algorithm results in a _higer_ conversion rate than either the current method or displaying no adverts at all (again, this difference is statistically significant).

## Conclusion

It is therefore possible to recommend the new advertising demand. Simple statistical analysis shows the three methods to be different when measured by conversion rate (the ratio of pageviews to reservations). When determining the direction of these differences, it has been shown that the current method is statistically _less_ effective than displaying _no_ advertisements at all! The new method out-performs both the current method _and_ displaying no advertisements at a statistically significant rate. Therefore the new ad-delivery algorithm is highly recommended. 
