...
kable(tidy(model211), col.names = c("Term", "Estimate", "Std. Error", "t-Stat.", "p-Value"), caption = "Table 1: Coefficients", digits = 3)
...
```{r show_store_model}
kable(tidy(model212), col.names = c("Term", "Estimate", "Std. Error", "t-Stat.", "p-Value"),caption = "Table 3: Coefficients", digits = 3)
...
```{r show_mail_model}
kable(tidy(model213), col.names = c("Term", "Estimate", "Std. Error", "t-Stat.", "p-Value"), caption = "Table 5: Coefficients",digits = 3)
...
```{r show_phone_model}
kable(tidy(model214), col.names = c("Term", "Estimate", "Std. Error", "t-Stat.", "p-Value"),caption = "Table 7: Coefficients", digits = 3)
...
```{r, echo=FALSE}
kable(tidy(model224), col.names = c("Term", "Estimate", "Std. Error", "t-Stat.", "p-Value"), caption = "Table 9: Coefficients", digits = 3)
...
```{r}
kable(tidy(model221), col.names = c("Term", "Estimate", "Std. Error", "t-Stat.", "p-Value"),caption = "Table 11: Coefficients", digits = 3)
...
```{r}
kable(tidy(model223), col.names = c("Term", "Estimate", "Std. Error", "t-Stat.", "p-Value"), caption = "Table 13: Coefficients", digits = 3)
...
```{r}
kable(tidy(model222), col.names = c("Term", "Estimate", "Std. Error", "t-Stat.", "p-Value"), caption = "Table 15: Coefficients",digits = 3)
...
```{r kin_email_dist, fig.cap = "Figure 13: Distribution of number of emails and catalogues sent to customers"}
