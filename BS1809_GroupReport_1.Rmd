...
kable(tidy(model211), col.names = tidy_names, caption = "Table 1: Coefficients", digits = 3)
kable(glance(model211), col.names = toproper(glance(model211) %>% names()), caption = "Table 2: Regression Statistics", digits = 3)
```
...
```{r show_store_model}
kable(tidy(model212), col.names = tidy_names,caption = "Table 3: Coefficients", digits = 3)
kable(glance(model212), col.names = toproper(glance(model212) %>% names()), caption = "Table 4: Regression Statistics", digits = 3)
```
...
```{r show_mail_model}
kable(tidy(model213), col.names = tidy_names, caption = "Table 5: Coefficients",digits = 3)
kable(glance(model213), col.names = toproper(glance(model213) %>% names()),caption = "Table 6: Regression Statistics", digits = 3)
```
...
```{r show_phone_model}
kable(tidy(model214), col.names = tidy_names,caption = "Table 7: Coefficients", digits = 3)
kable(glance(model214), col.names = toproper(glance(model214) %>% names()),caption = "Table 8: Regression Statistics", digits = 3)
```
...
```{r, echo=FALSE}
kable(tidy(model224), col.names = tidy_names, caption = "Table 9: Coefficients", digits = 3)
kable(glance(model224), col.names = toproper(glance(model224) %>% names()),caption = "Table 10: Regression Statistics", digits = 3)
```
...
```{r}
kable(tidy(model221), col.names = tidy_names,caption = "Table 11: Coefficients", digits = 3)
kable(glance(model221), col.names = toproper(glance(model221) %>% names()), caption = "Table 12: Regression Statistics", digits = 3)
```
...
```{r}
kable(tidy(model223), col.names = tidy_names, caption = "Table 13: Coefficients", digits = 3)
kable(glance(model223), col.names = toproper(glance(model223) %>% names()), caption = "Table 14: Regression Statistics", digits = 3)
```
...
```{r}
kable(tidy(model222), col.names = tidy_names, caption = "Table 15: Coefficients",digits = 3)
kable(glance(model222), col.names = toproper(glance(model222) %>% names()), caption = "Table 16: Regression Statistics",digits = 3)
```
