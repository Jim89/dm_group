...
```
```{r, echo=FALSE}
kable(tidy(model), caption = "Table 1: Coefficients", digits = 3)
kable(glance(model), caption = "Table 2: Regression Statistics", digits = 3)
```
...
model = lm(df$line_dollars ~ df$childrenFactor)

```
```{r, echo=FALSE}
kable(tidy(model), caption = "Table 3: Coefficients", digits = 3)
kable(glance(model), caption = "Table 4: Regression Statistics", digits = 3)
