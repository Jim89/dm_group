...
Results for all four scenarios are similar. Although the p-values of store distance in all four models are very significant, the R-squared and estimate are considerably low. That implies the indepedent variable - store distance might be statistically significant but it is not economically significant at all, which was also supported by the scatter plot where no trend was observed in the graphs.
