...
### Reviews VS Stars
Onlyreviews with a considerable amount of contents were included as topic modelling is unable to extract insight from short reviews. The length of reviews was therefore analysed and a minimum requirement on review length was implemented.
...
Inituitively, we thought there would be more 1-star and 5-star reviews, however, the data shows otherwise, and the majority of reviews were 4-star and 5-star. It is also important to examine the number of votes of a review whihc indicate the reliability/usefulness.
...
This part of the analysis estimates the demand for restaurants in an area (zip code) of a chosen city, and finds out which type of cuisine people are looking for. 
...
#  Type and Characteristics - Analysis
...
# Price, Volume and Revenue - Analysis
To calculate potential revenue, we estimate the amount of customers a restaurant may receive as a multiple of the number of british restaurant reviews. (figure 10) We assume that the number of reviews indicate approximately .1% of total visits. For EH3 there are 161 reviews for British restaurants and 17 British restaurants in total and hence there are 9.47 average number of Reviews per British Restaurant for EH3. We can expect that for a year there will be around 9470 customers per year (9.47 * 1000). Note that the check-in dataset could also have been used as an alternative indicator of volumes, but check-ins are based on the amount of offers and so may represent a biased value for our analysis. 
