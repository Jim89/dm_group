...
## Methodology
This analysis is conduced for Edinburgh only. This was because extensive demographic data was found that could be easily integrated with the Yelp dataset. The team also had better knowledge of the zip codes as Edinburgh is still in the UK. 
This report is split into three main analyses, then concluded with an estimation of revenues and a summary.

**Topic Modelling Analysis**
The reviews of Edinburgh's resturants are grouped into topics using a NMF topic modelling method to look for potential topics or opportunities to exploit.

**Demand and Location Analysis**
Summary statistics such the number of reviews per resturant and number of reviews by cuisine are mapped out, to give an indication of relative demand by location, which allows for a recommendation of location.

**Competition and Style Analysis**
A metric of competition is computed for different styles of resturant to recommend the appropriate attributes of the resturant.
...
!["Fig 10: Dendrogram on style clustering" ](kin_fig1.png)
...
!["Fig 11: Inconsistency Measure of last 20 merges" ](kin_fig2.png)

!["Fig 12: Height of the last 20 merges" ](kin_fig3.png)

!["Fig 13: Rate of increase in Height of the last 20 merges" ](kin_fig4.png)

From the plots, a cut with 5 clusters gives the most desired result.
The each cluster's attribute count as a percentage of the population is shown below, as barplots.
...
!["Fig 14: Cluster 1: Unknowns" ](kin_fig5.png)
...
!["Fig 15: Cluster 2: The Classies" ](kin_fig6.png)
...
!["Fig 16: Cluster 3: The Stylish and Pubs & Bars" ](kin_fig7.png)
...
!["Fig 17: Cluster 4: The Fastfood and Takeaways" ](kin_fig8.png)
...
!["Fig 18: Cluster 5: The Generals" ](kin_fig9.png)
...
!["Table 2: Restaurants distributions across zips" ](kin_fig10.png)
...
!["Table 3: Reviews distributions across zips" ](kin_fig11.png)
...
!["Table 5: Average number of Reviews for British Restaurant per Zip"](Table2.png)
...
!["Figure 19: Average Price for British Cusine"](figure10.png)
...
!["Table 6: Yelp Symbol to Value" ](table3.png)
