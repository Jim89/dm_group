...
```
Only reviews with a considerable amount of contents should be included as the topic modelling will not be able to extract insights from short reviews. The length of reviews was therefore analysed and a minimum requirement on the length of review was implemented.
...
### Topics in bad and good reviews {.tabset .tabset-fade}
...
This section estimates the demand for different restaurants per Edinburgh zip code, and looks at the competition per zip.
...
!["Figure 7: Average rating per zip code and number of resturants by cuisine" ](figure7.png)
...
The topic modeling analysis from the first section, found two recommendations 1) that customers are not satisfied with the type of batter for fish and chips in Edinburgh, which was complained to be too soggy and 2) that customers are also not particularly happy with chicken dishes in Edinburgh. Therefore in EH3, teh resturant should focus on being really good at making chicken as well as Fish. It is further recommended that "Chicken and Fish" are the only foods offered in the restaurant so that it can specialize in making it good.

# Type and Characteristics

This section classifies different kinds of restaurants using hierachical clustering to.........

After that we would analyse the distribution of these restaurants and compare it with the distribution of reviews given to these restaurants. By analysing the distribution difference between top reviews and restaurants, we can find out areas where customers do not receive enough satisfying services and locate a strategic location for our restaurant.
...
!["Fig 1: Dendrogram on style clustering" ](kin_fig1.png)
...
!["Fig 2: Inconsistency Measure of last 20 merges" ](kin_fig2.png)

!["Fig 3: Height of the last 20 merges" ](kin_fig3.png)

!["Fig 4: Rate of increase in Height of the last 20 merges" ](kin_fig4.png)
...
!["Fig 5: Cluster 1: Unknowns" ](kin_fig5.png)
...
!["Fig 6: Cluster 2: The Classies" ](kin_fig6.png)
...
!["Fig 7: Cluster 3: The Stylish and Pubs & Bars" ](kin_fig7.png)
...
!["Fig 8: Cluster 4: The Fastfood and Takeaways" ](kin_fig8.png)
...
!["Fig 9: Cluster 5: The Generals" ](kin_fig9.png)
...
The distribution of different types of restaurants in different zips and the distribution of supply of different kind of restaurants are analysed in the following tables.
...
!["Table 1: Restaurants distributions across zips" ](kin_fig10.png)
...
Similar analysis can be done for the distribution of top rating review for each restaurant types in different zips. It is used as an indicator of popular location for certain type of restaurants.

!["Table 2: Reviews distributions across zips" ](kin_fig11.png)
...
From the tables the above, the ratio of restaurants receiving top reiviews is calculated. For instance, fastfood and takeaways in EH1 receives 39.7% of top reviews in the Fastfood & Takeaways category with only 22.8% of Fastfood & Takeaway restaurants located in the zip. It implies that the quality of Fastfood & Takeaways in EH1 are generally more satisfying than those located in other zip.

To observe the differences, please look at Table 3 below.

!["Table 3: Disagreement of percentage distributions of review and restaurant across zips" ](kin_fig13.png)

To observe the performance level, a ratio as an indicator of high quality region is created. The indicator of out-performing region is displayed in Table 4 below.

$$\frac{(\text{top review%} - \text{restaurants%})}{\text{%restaurants}}$$

!["Table 4: Ratio of disagreement of percentage distributions of review and restaurant across zips" ](kin_fig12.png)
...
From the calculation above, out-performing zips for different types of restaurants can be identified.
...
Now, depends on the estimated quality of our service, strategic considerations are made based on the the result. 

**Strategy 1 - Competition Avoidance:**

We locate our restaurant at a zip with a relatively lower percentage of top reviews than the the percentage of restaurants to avoid competition with top quality restaurants and take up those unsatisfied demand in the zip.
However, as the amount of reviews is also a proxy of traffic, we may want to as well avoid under-performing zips as well. Hence, the best location would be zips having the supply demand ratio close to zero while having a certain amount of of restaurants of the same type. 
...
**Strategy 2 - Business Agglomeration:**
...
**Choice and recommendation for our restaurant**
