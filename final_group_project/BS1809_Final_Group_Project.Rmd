...
Summary statistics such the number of reviews per resturant and by cuisine are mapped out, to give an indiaciton of relative demand by location, which allows for a recommendation of location.
...
!["Table5: Average number of Reviews for British Restaurant per Zip"](Table2.png)
